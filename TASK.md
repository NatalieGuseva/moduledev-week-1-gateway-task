...
Регистрация, сдача ссылки и получение результата выполняются через production-бот курса. Пошаговая инструкция: [как пользоваться ботом ModuleDev](docs/bot-guide.md).
